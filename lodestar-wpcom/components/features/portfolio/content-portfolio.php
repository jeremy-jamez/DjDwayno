	...
	<?php if ( '' !== get_the_post_thumbnail() ) : ?>
		<div class="post-thumbnail">
			...
			if ( is_page_template( 'templates/portfolio-page.php' ) ) : ?>
				...
				<img data-original="<?php echo esc_url( $project_image[0] ); ?>" width="900" height="600" class="portfolio-featured-image" alt="<?php the_title(); ?>" title="<?php the_title(); ?>">

			<?php else : ?>
				<img src="<?php echo esc_url( $project_image[0] ); ?>" width="900" height="600" class="portfolio-featured-image" alt="<?php the_title(); ?>" title="<?php the_title(); ?>">
